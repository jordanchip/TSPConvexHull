...
namespace TSP
{
    ...
    class ProblemAndSolver
    {
        ...
        public string[] bBSolveProblem()
        {
            ...
            BBoundStateSolver solver = new BBoundStateSolver(Cities);
            string[] returnString = solver.solve(time_limit);
            bssf = new TSPSolution(solver.getBSSF().path);
            return returnString;
        }
        ...
        public string[] greedySolveProblem()
        {
            ...
            string[] returnString = solver.solve(60);
            bssf = new TSPSolution(solver.getBSSF().path);
            return returnString;
        }
        ...
        public string[] fancySolveProblem()
        {
            ...
            MySolver solver = new MySolver(Cities);
            string[] returnString = solver.solve(60);
            bssf = new TSPSolution(solver.getBSSF().path);
            return returnString;
        }
